  ...
  <ol class="max-w-screen-xl w-full px-4 flex space-x-4 sm:px-6 lg:px-8">
    ...
    <li class="flex">
      <div class="flex items-center">
        ...
        <a href="http://cms/VCM-Project-CMS/index.php?app=nexus&mod=forum&ctl=index&cmpt=topic" aria-current="page" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Catégorie</a>
      </div>
    </li>
  </ol>
</nav>
