...
<div class="bg-white shadow sm:rounded-lg mx-24 my-24 p-5">
    <form action="#" method="POST">
        ...
        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
            ...
            <a href="index.php?app=admin&mod=community&ctl=members&cmpt=modify&mid=<?php echo $uid; ?>" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:w-auto sm:text-sm">
            Annuler
            </a>
        </div>
    </form>
