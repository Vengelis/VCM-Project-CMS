 ...
 * @ Modified time: 2021-01-19 22:40:43 
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div class="mt-2">
                        <p class="text-sm text-gray-500">
                            il semblerait que la requete ne soit pas complete... Vérifiez que toutes les informations renseignées sont correctes. Si le problème perciste, contactez vorte administrateur. Si le problème ne peut être résolu par l'adminitrateur, contactez l'équipe VCM Project.
                        </p>
                    </div>
                </div>
            </div>
