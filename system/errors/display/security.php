 ...
 * @ Modified time: 2021-01-19 22:40:53 
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div class="mt-2">
                        <p class="text-sm text-gray-500">
                            Vous n'êtes pas en mesure d'accéder à des pages sans leurs chargeurs. Une erreur à due se produire lors de la redirection avec le lien. Cliquez sur le bouton "retour" pour retourner sur la page d'accueil. Si vous pensez que c'est une erreur, contacter l'administrateur du site.
                        </p>
                    </div>
                </div>
            </div>
