 ...
 * @ Modified time: 2021-01-19 22:40:26 
...
?>
    ...
    <aside class="hidden relative xl:order-first xl:flex xl:flex-col flex-shrink-0 w-56">
        ...
        <div id="subMenu3" class="hidden absolute inset-0 py-3 px-3 sm:px-3 lg:px-4 bg-gray-600 border-l border-gray-700">
          ...
          <a href="index.php?app=admin&mod=community&ctl=moderation&cmpt=warn_sys" class="text-gray-300 hover:bg-gray-800 group flex items-center px-2 py-1 text-sm rounded-md">Avertissement</a>
